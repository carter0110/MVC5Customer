namespace TaskMVC.Models
{
	public static class RepositoryHelper
	{
		...
		public static ViewCustomerRepository GetViewCustomerRepository()
		{
			var repository = new ViewCustomerRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static ViewCustomerRepository GetViewCustomerRepository(IUnitOfWork unitOfWork)
		{
			var repository = new ViewCustomerRepository();
